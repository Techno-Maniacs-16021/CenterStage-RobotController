...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -5761.913104674297; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -6470.541726931383; // x position of the perpendicular encoder (in tick units)
    }
