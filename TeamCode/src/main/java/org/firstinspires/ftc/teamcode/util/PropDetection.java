...
public class PropDetection extends OpenCvPipeline {
    ...
    //TODO
    // TOPLEFT anchor point for the bounding box -> edit this for the sleeve and robot position
    // red = 230
    // blue = 290

    private static Point SLEEVE_TOPLEFT_ANCHOR_POINT = new Point(260, 168);

    //TODO
    // Width and height for the bounding box -> edit this for the sleeve and robot position
